            ...
            <form onSubmit={handleAdd} className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                ...
                <input
                  ...
                  className="w-full border border-gray-200 rounded-lg px-3 py-2 text-sm text-gray-900 focus:outline-none focus:ring-2 focus:ring-[#1B2A6B]/20 placeholder:text-gray-500"
                  required
                />
              </div>
              <div>
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full border border-gray-200 rounded-lg px-3 py-2 text-sm text-gray-900 focus:outline-none focus:ring-2 focus:ring-[#1B2A6B]/20 uppercase placeholder:text-gray-500"
                  maxLength={6}
                  required
                />
              </div>
              <div>
                ...
                <select
                  ...
                  className="w-full border border-gray-200 rounded-lg px-3 py-2 text-sm text-gray-900 focus:outline-none focus:ring-2 focus:ring-[#1B2A6B]/20 bg-white"
                >
